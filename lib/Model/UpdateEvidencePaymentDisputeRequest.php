...
'line_items' => 'getLineItems'    ];
     ...
     * Sets files
     *
     * @param \Swagger\Client\Model\FileEvidence[] $files This array is used to specify one or more evidence files that will be added to the evidence set associated with a payment dispute. At least one evidence file must be specified in the files array. The unique identifier of an evidence file is returned in the response payload of the uploadEvidence method.
     *
     * @return $this
     */
