...
class PickupStep implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $merchant_location_key A merchant-defined unique identifier of the merchant's store where the buyer will pick up their In-Store Pickup order. This field is always returned with the pickupStep container.
     *
     * @return $this
     */
