...
class PaymentDisputeApi
{
    ...
    protected function fetchEvidenceContentRequest($payment_dispute_id, $evidence_id, $file_id)
    {
        ...
        // query params
        if ($evidence_id !== null) {
            $queryParams['evidence_id'] = ObjectSerializer::toQueryValue($evidence_id);
        }
        // query params
        if ($file_id !== null) {
    ...
    protected function getPaymentDisputeSummariesRequest($order_id = null, $buyer_username = null, $open_date_from = null, $open_date_to = null, $payment_dispute_status = null, $limit = null, $offset = null)
    {
        ...
        if ($buyer_username !== null) {
            $queryParams['buyer_username'] = ObjectSerializer::toQueryValue($buyer_username);
        }
        // query params
        if ($open_date_from !== null) {
            $queryParams['open_date_from'] = ObjectSerializer::toQueryValue($open_date_from);
        }
        // query params
        if ($open_date_to !== null) {
            $queryParams['open_date_to'] = ObjectSerializer::toQueryValue($open_date_to);
        }
        // query params
        if ($payment_dispute_status !== null) {
            $queryParams['payment_dispute_status'] = ObjectSerializer::toQueryValue($payment_dispute_status);
        }
        // query params
        if ($limit !== null) {
